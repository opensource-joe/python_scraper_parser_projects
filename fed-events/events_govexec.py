...
upcoming_url = upcoming_card.find_all('a')

upcoming_url_dups = []
for link in upcoming_url:
    upcoming_url_dups.append(link.get('href'))
    
# upcoming_url_final = []
# [upcoming_url_final.append(x) for x in upcoming_url_dups if x not in upcoming_url_final]

# TODO: filter to first URL to not print all three as dups